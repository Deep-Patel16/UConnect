...
<?php
 foreach($other_users as $id=>$score) {
   ...
   $details_stmt = $mysqli->prepare("SELECT Forename, Surname, Course, Facebook, Instagram, Snapchat FROM Users WHERE id=?");
   $details_stmt->bind_param("s", $id);
   $details_stmt->bind_result($fname, $sname, $course, $fb, $igm, $sc);
       ...
       <div class="card p-0">
           ...
           <div class="card-content d-flex flex-column align-items-center">
               ...
               <ul class="social-icons d-flex justify-content-center">
                   <li style="--i:1"> <a href='. $fb .'  target="_blank"> <span class="fab fa-facebook"></span> </a> </li>
