              ...
              <div class="col-12 col-md-10 d-none d-xl-block">
                <nav class="site-navigation position-relative text-right" role="navigation">
                  ...
                  <ul class="site-menu js-clone-nav mr-auto d-none d-lg-block" >
                    <li><a href="../Home_page/index.html"><span style="color:purple">Home Page</span></a></li>
                    <li><a href="../Friends_page/final.php"><span style="color:purple">Friends</span></a></li>
                    <li ><a href="../Login_page/index.html"><span style="color:purple">Log Out</span></a></li>
                  </ul>
                </nav>
              </div>
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="p-3 py-5">
                        ...
                        <div class="col-md-12"><label class="labels"><img src="twittericon.png" alt="twitter Logo" width="40" height="40"><br></label><input type="text" class="form-control" placeholder="Twitter Link" name="snapchat" value=<?php echo($social_array[3]);?> > </div><br>
